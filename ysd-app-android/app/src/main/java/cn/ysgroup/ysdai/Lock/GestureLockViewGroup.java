...
public class GestureLockViewGroup extends RelativeLayout {
        ...
        public void handleMessage(Message msg) {
            ...
            dialog.getMessage().setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    //进入主页
                    if (!TextUtils.isEmpty(GestureCodeActivity.from) && GestureCodeActivity.from.equals("welcome")
                            ) {
                        ...
                        Intent intentExti = new Intent("MoreBroadCast");
                        intentExti.putExtra("value", "gesture");
                        context.sendBroadcast(intentExti);
                        //通知关闭activity
    ...
    public GestureLockViewGroup(Context context, AttributeSet attrs,
        ...
        if (string != null)
            mTryTimes = Utils.str2Int(string) + 1;
        a.recycle();
...
//                reset();
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mOnGestureLockViewListener != null && mChoose.length() > 3) {
                    ...
                    if (!result) {
                        ...
                        if (!TextUtils.isEmpty(GestureCodeActivity.from) &&
                            ...
                            //密码正确 清除密码
                            mTryTimes = 6;
                            boolean isClean=context.getSharedPreferences(phone, Context.MODE_PRIVATE).edit().clear().commit();
                ...
                for (int i = 0; i + 1 < mChoose.length(); i++) {
                    int childId = Utils.str2Int(String.valueOf(mChoose.charAt(i)));
                    int nextChildId = Utils.str2Int(String.valueOf(mChoose.charAt(i + 1)));
...
//                mChoose = new StringBuilder();
    ...
    public void RequestForLogout(String basicUrl) {
        ...
        RequestBody body = new FormEncodingBuilder().add("token", PreferenceUtil.getPrefString(context, "loginToken", "")).
                build();
